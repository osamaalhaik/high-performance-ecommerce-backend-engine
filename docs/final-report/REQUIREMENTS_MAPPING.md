...
| Load Distribution | Load balancer server selection endpoint, weighted strategy, and Nginx reverse proxy configuration | Postman load balancer screenshots for server-1, server-2, server-3, and infra/nginx/nginx.conf |
